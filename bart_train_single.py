...
class SeqDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        token_ids_src = tokenizer.encode(src, max_length=input_max_seq_len)
        token_ids_tgt = tokenizer.encode(tgt, max_length=output_max_seq_len)
        output = {
            ...
            if step % 10000000 == 0:
                ...
                for text in test_data:
                    print(self.model.sample_generate_encoder_decoder(
                        text, input_max_length=input_max_seq_len, out_max_length=output_max_seq_len, add_eos=True, top_k=20))
                self.model.train()
